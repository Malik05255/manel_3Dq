...
object SpatialGraphEngine {
    ...
    data class Report(val edges: List<Edge>, val isolated: List<String>, val privacyContacts: List<String>, val candidates: List<Candidate>)
    ...
    fun analyze(plan: FloorPlan): Report {
        ...
        return Report(edges, isolated, privacy, candidates)
    }
